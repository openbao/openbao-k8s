...
func TestCommandEnvBools(t *testing.T) {
	...
	tests := []struct {
		...
		{env: "AGENT_INJECT_ENABLE_VAULT_ANNOTATIONS", value: true, cmdPtr: &cmd.flagEnableVaultAnnotations},
		{env: "AGENT_INJECT_ENABLE_VAULT_ANNOTATIONS", value: false, cmdPtr: &cmd.flagEnableVaultAnnotations},
		{env: "AGENT_INJECT_REWRITE_VAULT_ANNOTATIONS", value: true, cmdPtr: &cmd.flagRewriteVaultAnnotations},
		{env: "AGENT_INJECT_REWRITE_VAULT_ANNOTATIONS", value: false, cmdPtr: &cmd.flagRewriteVaultAnnotations},
	}
