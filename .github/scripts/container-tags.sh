...
#
# $ VERSION=v2.5.5 .github/scripts/release/container-tags.sh
...
IMAGE_NAME=${IMAGE_NAME:-openbao/openbao-k8s}
GITHUB_OUTPUT=${GITHUB_OUTPUT:-/dev/stdout}
GITHUB_REPOSITORY=${GITHUB_REPOSITORY:-openbao/openbao-k8s}
