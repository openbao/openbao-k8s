	...
	tests := []struct {
	...
	}{
		{
			map[string]string{
				...
				"openbao.org/agent-inject-secret-barfoo":        "test1",
				"openbao.org/agent-inject-template-barfoo":      "",
				"openbao.org/agent-template-left-delim-barfoo":  "${",
				"openbao.org/agent-template-right-delim-barfoo": "}",
				"openbao.org/agent-inject-template-file-barfoo": "/etc/config.tmpl",

				"openbao.org/agent-inject-secret-test3":        "test3",
				"openbao.org/agent-inject-template-test3":      "foobarTemplate3",
				"openbao.org/agent-inject-template-file-test3": "",
				"openbao.org/agent-template-left-delim-test3":  "",
				"openbao.org/agent-template-right-delim-test3": "",

				"openbao.org/agent-inject-template-only-template-2":      "onlyTemplate2",
				"openbao.org/agent-template-left-delim-only-template-2":  "${",
				"openbao.org/agent-template-right-delim-only-template-2": "}",

				"openbao.org/agent-inject-template-file-only-template-file-2": "onlyTemplateFile2",
				"openbao.org/agent-template-left-delim-only-template-file-2":  "${",
				"openbao.org/agent-template-right-delim-only-template-file-2": "}",
			},
			map[string]Secret{
				"foobar": {
					Name:           "foobar",
